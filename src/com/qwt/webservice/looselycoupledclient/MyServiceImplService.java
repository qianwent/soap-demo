 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://server.webservice.qwt.com/", wsdlLocation = "http://localhost:8888/ns?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://server.webservice.qwt.com/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://server.webservice.qwt.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.qwt.com/", "MyServiceImplPort"), IMyService.class, features);
    }
